...
\begin{itemize}
	...
	\item Die Endsilbe \emph{-konzept} betont den Netzcharakter im Gegensatz zu schnell-intuitiven Einsch\"{a}tzungen. In stabilen, weil \say{erfolgreichen} pers\"{o}nlichen
