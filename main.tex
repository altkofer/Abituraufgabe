...
\begin{figure}[h]
	\centering
	\includegraphics[scale=.75]{Layout.png}
...
\include{Kapitel/1_denk}
\include{Kapitel/2_begr}
\include{Kapitel/3_erkenntnis.tex}
\include{Kapitel/4_did_modelle}
\include{Kapitel/5_guter_UR}
\include{Kapitel/6_bildungsstandards}
\include{Kapitel/7_lernziele}
\include{Kapitel/8_schuelervorst}
\include{Kapitel/9_aufber}
\include{Kapitel/10_strukturierung}
\include{Kapitel/11_methoden}
\include{Kapitel/12_unterrichtsentwurf}
\include{Kapitel/13_experimentieren}
\include{Kapitel/14_medien}
\include{Kapitel/15_schulprofile}
\include{Kapitel/16_literatur}
